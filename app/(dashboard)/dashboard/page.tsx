...
const BAR_DATA = [
  { date: "Jan 29", subs: 120 }, { date: "Jan 31", subs: 145 },
  { date: "Feb 02", subs: 98 },  { date: "Feb 04", subs: 167 },
  { date: "Feb 06", subs: 134 }, { date: "Feb 08", subs: 189 },
  { date: "Feb 10", subs: 156 }, { date: "Feb 12", subs: 210 },
  { date: "Feb 14", subs: 178 }, { date: "Feb 16", subs: 234 },
  { date: "Feb 18", subs: 198 }, { date: "Feb 20", subs: 256 },
  { date: "Feb 22", subs: 221 }, { date: "Feb 24", subs: 278 },
  { date: "Feb 26", subs: 243 }, { date: "Feb 28", subs: 295 },
];
    ...
    <div className="space-y-5 animate-fade-slide-up">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="btn-outline flex items-center gap-1.5">Last 30 days ▾</button>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="lg:col-span-2 border border-border bg-card animate-scale-in">
          <div className="border-b border-border px-5 py-3">
            <div className="flex items-center justify-between">
              <button className="text-xs font-medium text-foreground border-b border-foreground pb-0.5 mr-3">Net revenue ▾</button>
              <div className="flex items-center gap-4 text-xs text-muted-foreground">
                <span className="flex items-center gap-1.5"><span className="h-2 w-2 bg-emerald-500" /> Calls <span className="font-mono font-semibold text-foreground ml-1">318</span></span>
                <span className="flex items-center gap-1.5"><span className="h-2 w-2 bg-orange-400" /> Avg. sats <span className="font-mono font-semibold text-foreground ml-1">$292.87</span></span>
              </div>
            </div>
          </div>
        ...
        <div className="border border-border bg-card animate-scale-in">
          <div className="border-b border-border px-5 py-3">
            <button className="text-xs font-medium text-foreground border-b border-foreground pb-0.5">Subscriptions ▾</button>
          </div>
          <div className="px-5 pt-3 pb-1">
            <p className="text-2xl font-bold tracking-tight text-foreground">3,260</p>
            <p className="mt-0.5 text-xs text-muted-foreground"><span className="font-semibold text-green-600 dark:text-green-400">+56%</span> vs 2,080 last period</p>
          </div>
      ...
      <div className="border border-border bg-card animate-fade-in">
        <div className="flex items-center justify-between border-b border-border px-5 py-3">
          ...
          <div className="flex items-center gap-2">
            <button className="btn-outline flex items-center gap-1.5"><Download className="h-3.5 w-3.5" /> Export</button>
            <button className="btn-primary flex items-center gap-1.5 py-1.5 px-3">+ Add agent <kbd className="ml-1 border border-white/20 px-1 text-[10px]">/</kbd></button>
          </div>
        </div>
            ...
            {RECENT_AGENTS.map((a, i) => (
              <tr key={a.email} className={`table-row-hover ${i < RECENT_AGENTS.length - 1 ? "border-b border-border" : ""}`}>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center bg-muted text-[10px] font-bold text-muted-foreground">{a.name[0]}</div>
                ...
                <td className="px-4 py-3 text-muted-foreground"><button className="text-xs hover:text-foreground">···</button></td>
              </tr>
            ))}
          </tbody>
        </table>
